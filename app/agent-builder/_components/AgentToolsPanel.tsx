    ...
    <div className="bg-white p-5 rounded-2xl shadow">
      ...
      <div>
        {AgentTools.map((tool, index) => (
          <div
            key={index}
            className="flex items-center gap-3 p-2 cursor-pointer hover:bg-radial from-purple-500 to-indigo-900 rounded-lg"
          ...
          >
            ...
            />
            <h2 className="text-sm font-medium text-black">{tool.name}</h2>
          </div>
        ))}
      </div>
    </div>
